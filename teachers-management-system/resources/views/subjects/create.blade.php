...
@section('content')
<div class="mb-4">
    <h1><i class="fas fa-plus-circle"></i> {{ isset($subject) ? 'Edit' : 'Add' }} Subject</h1>
</div>
<div class="row">
    <div class="col-md-6">
        <div class="card">
            <div class="card-body">
                <form action="{{ isset($subject) ? route('subjects.update', $subject) : route('subjects.store') }}" method="POST">
                    ...
                    <div class="d-flex gap-2">
                        <button type="submit" class="btn btn-primary"><i class="fas fa-save"></i> {{ isset($subject) ? 'Update' : 'Add' }}</button>
